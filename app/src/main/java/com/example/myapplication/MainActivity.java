...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView playerOneName,playerTwoName,xWin,oWin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xWin = findViewById(R.id.txt_win_x);
        oWin = findViewById(R.id.txt_win_o);
        int countPlayerX = 0;
        int countPlayerO = 0;
    ...
    private void changePlayerTurn(int currentPlayerTurn){
        ...
        if(playerTurn == 1){
            ...
            playerTwoLayout.setBackgroundResource(R.drawable.back);
        }
        else{
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_blue_border);
            playerOneLayout.setBackgroundResource(R.drawable.back);
